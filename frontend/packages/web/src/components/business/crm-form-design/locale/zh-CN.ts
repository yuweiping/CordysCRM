export default {
  ...
  'crmFormDesign.cn.P': '省',
  'crmFormDesign.cn.PC': '省-市',
  'crmFormDesign.cn.PCD': '省-市-区',
  'crmFormDesign.cn.PCDDetail': '省-市-区-详细地址',
  'crmFormDesign.dataSourceSingle': '数据单选',
  'crmFormDesign.dataSourceMultiple': '数据多选',
  'crmFormDesign.dataSource': '数据源',
  'crmFormDesign.dataSourceTableDisplayField': '数据源列表显示字段',
  'crmFormDesign.dataSourceTableDisplayFieldShow': '显示',
  'crmFormDesign.dataSourceTableDisplayFieldCount': '个字段',
  ...
  'crmFormDesign.serialNumberRuleAutoCountTip': '{number} 位数字，不自动重置',
