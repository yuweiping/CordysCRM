export default {
  ...
  'opportunity.quotation.new': '新建报价',
  'opportunity.quotation.voidTitleTip': '确认作废 {name} 报价吗？',
  'opportunity.quotation.invalidContentTip': '作废后，报价不可恢复，请谨慎操作！',
  'opportunity.quotation.searchPlaceholder': '通过报价名称/商机名称搜索',
  'opportunity.quotation.batchInvalidTitleTip': '确认作废 {number} 个报价吗？',
  'opportunity.quotation.deleteTitleTip': '确认删除 {name} 报价吗？',
  'opportunity.quotation.deleteContentTip': '删除后，报价不可恢复，请谨慎操作！',
  'opportunity.quotation.approvalResult': '审批结果',
  'opportunity.quotation.all': '全部报价',
  'opportunity.quotation.department': '部门报价',
  'opportunity.quotation.my': '我的报价',
